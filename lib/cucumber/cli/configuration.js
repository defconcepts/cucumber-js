function Configuration(argv) {
  ...
  var self = {
    ...
    getFilter: function getFilter() {
      ...
      var astFilter = Cucumber.Runtime.Filter(rules);
      return astFilter;
    },
    ...
    getTagAstFilterRules: function getTagAstFilterRules() {
      ...
      tagGroups.forEach(function (tags) {
         var rule = Cucumber.Runtime.Filter.AnyOfTagsRule(tags);
         rules.push(rule);
      });
      return rules;
    },
    ...
    getSingleScenarioAstFilterRule: function getSingleScenarioAstFilterRule() {
      ...
      var rule = Cucumber.Runtime.Filter.ScenarioAtLineRule(suppliedPaths);
      return rule;
    },
